    ...
    <>
        <div className="footerContainer" dir={isRTL ? "rtl" : "ltr"} >
            ...
            <div className="iconContainer">
                <PaymentIcons />
                <div className="icons">
                    <a href="https://www.instagram.com/femto_trade" target="_blank" rel="noopener noreferrer">
                    ...
                    <a href="https://www.facebook.com/share/femto_trade" target="_blank" rel="noopener noreferrer">
